...
const Home = () => {
  return (
    <div
      className={`bg-hero bg-no-repeat bg-center bg-cover w-full min-h-screen pb-14`}
    >
      <div>
      ...
      <div className="flex items-center justify-between flex-col lg:flex-row px-10">
        ...
        <div className="bg-primary-900 animate__animated animate__fadeInRight mt-20 flex flex-col items-center justify-center gap-y-3 shadow-2xl border-primary-800 border-2 p-10 rounded-3xl">
